use super::core::MarketData;
use crate::api::systems::market::core::DataPoint;
use chrono::DateTime;
use core::f64;
...
impl MarketData {
    ...
    pub async fn get_rsi(symbol: &str, interval: &str, time_periode: usize) -> Self {
        // Fetch 72 lastest prices.
        let prices_x = MarketData::fetch_market_data(symbol, interval, 72).await;
